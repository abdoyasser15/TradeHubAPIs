...
namespace TradeHub.Controllers
{
    public class SubCategoryController : BaseApiController
    {
        ...
        public async Task<ActionResult<IReadOnlyList<SubCategoryDto>>> GetActiveSubCategories()
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<SubCategoryDto>> AddSubCategory([FromBody] CreateSubCategoryDto categoryDto)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<SubCategoryDto>> UpdateSubCategory(int id, [FromBody] SubCategoryDto categoryDto)
        {
            try
            {
