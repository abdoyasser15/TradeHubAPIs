...
namespace TradeHub.Repository.Migrations
{
    ...
    [Migration("20260610123912_Add OrderItemOptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Basket.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Basket.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Basket.BasketItemOptions", b =>
                {
                    b.Property<int>("BaskItemOptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BaskItemOptionId"));
            ...
            modelBuilder.Entity("TradHub.Core.Entity.CompanyRatings", b =>
                {
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Favourite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Orders.OrderItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Payments.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.ProductOptionValue", b =>
                {
                    b.Property<int>("ProductOptionValueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.ProductOptions", b =>
                {
                    b.Property<int>("ProductOptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.ProductRating", b =>
                {
                    b.Property<int>("RaitingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.SubCategory", b =>
                {
                    b.Property<int>("SubCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Basket.BasketItem", b =>
                {
                    b.HasOne("TradHub.Core.Entity.Basket.Basket", "Basket")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Basket.BasketItemOptions", b =>
                {
                    b.HasOne("TradHub.Core.Entity.Basket.BasketItem", "BasketItem")
                        .WithMany("Options")
                        .HasForeignKey("BasketItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TradHub.Core.Entity.ProductOptionValue", "ProductOptionValue")
                        .WithMany()
            ...
            modelBuilder.Entity("TradHub.Core.Entity.CategoryAttribute", b =>
                {
                    b.HasOne("TradHub.Core.Entity.SubCategory", "SubCategory")
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Orders.OrderItem", b =>
                {
                    b.HasOne("TradHub.Core.Entity.Orders.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TradHub.Core.Entity.Orders.OrderItemOption", b =>
                {
                    b.HasOne("TradHub.Core.Entity.Orders.OrderItem", "OrderItem")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("TradHub.Core.Entity.ProductOptionValue", b =>
                {
                    b.HasOne("TradHub.Core.Entity.ProductOptions", "ProductOptions")
